...
class MockHomeData {
  ...
  static const List<ProductModel> topSkinCare = [
    ProductModel(
      id: 'skincare_1',
      name: 'Fixderma Salyzap 2% Salicylic Acid Body Spray | Anti Acne Body Care',
      packSize: '50 ml Spray',
      rating: 4.3,
      ratingCount: 650,
      imageUrl: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?auto=format&fit=crop&w=400&q=80',
      price: 366,
    ...
    ProductModel(
      id: 'skincare_2',
      name: 'Bioderma Atoderm Ultra-Nourishing Cream | Face & Body Care Protect',
      packSize: '200 ml Cream',
      rating: 4.4,
      ratingCount: 1420,
      imageUrl: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?auto=format&fit=crop&w=400&q=80',
      price: 719,
    ...
    ProductModel(
      id: 'skincare_3',
      name: 'Biluma Anti-Ageing & Skin Brightening Cream',
      packSize: '45 gm Cream',
      rating: 4.2,
      ratingCount: 890,
  ...
  static const List<ProductModel> dealsOfTheDay = [
    ProductModel(
      id: 'deal_1',
      name: 'Zandu Triphala Tablet | Eases Constipation & Supports Digestive Health',
      packSize: '30 tablets',
      rating: 4.4,
      ratingCount: 1200,
      imageUrl: 'https://images.unsplash.com/photo-1584017911766-d451b3d0e843?auto=format&fit=crop&w=400&q=80',
    ...
    ProductModel(
      id: 'deal_2',
      name: 'Dhootapapeshwar Arogyavardhini Tablet | Pure Liver & Digestive Care',
    ...
    ProductModel(
      id: 'deal_3',
      name: 'Pilgrim Brightening Face Wash with Vitamin C & Alpha Arbutin',
  ...
  static const List<ProductModel> petCareDeals = [
    ProductModel(
      id: 'pet_deal_1',
      name: "Bakson's Homoeopathy Distress Drop for Veterinary & Pet Care",
      packSize: '30 ml Drop',
      rating: 4.4,
      ratingCount: 310,
    ...
    ProductModel(
      id: 'pet_deal_2',
      name: 'Kitty Yums Dry Cat Food Ocean Fish Adult Nutrition',
      packSize: '3 kg Pet Food',
      rating: 4.6,
      ratingCount: 780,
    ...
    ProductModel(
      id: 'pet_deal_3',
      name: "Benny's French Gourmet Dog Food with Vital Probiotics",
      packSize: '1 Pack',
      rating: 4.3,
      ratingCount: 220,
